...
// The stage as stored, or `undefined` when there is none. A record no caller could use -- null,
// not an object, or missing a field -- is deleted on the way out.
...
// The stored stage while it is still committable; a non-finite clock reads as expired.
